...
namespace hooks
{
	...
	void __cdecl hooked_clmove(float accumulated_extra_samples, bool bFinalTick, CUserCmd* m_pcmd);
	...
	void __fastcall procedural_foot_plant(void* ecx, void* edx, void* boneToWorld, void* pLeftFootChain, void* pRightFootChain, void* pos);
