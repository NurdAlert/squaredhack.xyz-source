...
void C_ConfigManager::setup()
{
	...
	setup_item(&g_cfg.misc.funny_animations, false, crypt_str("Misc.funny_animations"));
	...
	setup_item(&g_cfg.esp.explosive_autopeek, true, crypt_str("Esp.explosive_autopeek"));
...
{
	std::string file = crypt_str("C:\\Squaredhack\\Configs\\") + config;
	json allJson;
...
{
	std::string file = crypt_str("C:\\Squaredhack\\Configs\\");
